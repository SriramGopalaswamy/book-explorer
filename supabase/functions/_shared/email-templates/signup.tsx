...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Verify your email for GRX10</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>Welcome to GRX10</Heading>
        <Text style={text}>
          Thanks for signing up! Please verify your email address ({recipient}) to access your dashboard.
        </Text>
