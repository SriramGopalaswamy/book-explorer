...
export const MagicLinkEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your sign-in link for GRX10</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>Sign in to GRX10</Heading>
        <Text style={text}>
          Click the button below to sign in to your dashboard. This link will expire shortly.
        </Text>
